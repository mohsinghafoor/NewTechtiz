...
export const OurExpertise = [
  {
    icon: images.ideationIcon,
    text: "Web Development",
    clr: "#f07b3b",
    count: "01",
  },
  {
    icon: images.softwareDevIcon,
    text: "Mobile Application Development",
    clr: "#954cf5",
    count: "02",
  },
  {
    icon: images.teamArgumentIcon,
